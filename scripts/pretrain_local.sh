#!/bin/bash
# Local training script for 4× A40 (46 GB) or RTX A6000 (49 GB) GPUs.
# Effective batch size = batch_size_per_gpu × nproc_per_node = 12 × 4 = 48,
# matching the original paper's V100 setup (6 × 8 = 48).
#
# Usage:
#   # StyleGAN interpolation (single MP4):
#   DATA_PATH=/path/to/stylegan_walk.mp4 DATA_FORMAT=stylegan bash scripts/pretrain_local.sh
#
#   # StyleGAN interpolation (directory of MP4 walks):
